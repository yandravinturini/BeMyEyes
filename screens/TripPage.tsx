...
export function TripPage(){    
  ...
  const trip2 = new Trip("yandra", "isabela","Nova Iorque", "2022-08-12", "2022-09-01", "passageiro")
  const trip3 = new Trip("isabela", "Hana","Amsterdam", "2022-11-15", "2022-11-18", "passageiro")
  const trip4 = new Trip("francisco", "giulia","Copenhagem", "2022-10-25", "2022-10-27", "viajante")
  const trip5 = new Trip("giulia", "yandra","Porto", "2022-05-20", "2022-05-24", "passageiro")
