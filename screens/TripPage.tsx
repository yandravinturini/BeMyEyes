...
export function TripPage(this: any, { navigation }: { navigation: any }) {

  const trip1 = new Trip("Ana", "João", "Rio de Janeiro", "Brazil", "2022-03-17", "2022-03-25", "passageiro", "https://images.unsplash.com/photo-1516306580123-e6e52b1b7b5f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1226&q=80", "https://images.unsplash.com/photo-1548449112-96a38a643324?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip2 = new Trip("Leo", "Jimmy", "New York", "United States", "2022-08-12", "2022-09-01", "passageiro", "https://images.unsplash.com/photo-1490644658840-3f2e3f8c5625?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", "https://images.unsplash.com/photo-1581803118522-7b72a50f7e9f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip3 = new Trip("Isa", "Hana", "Amsterdam", "Netherlands", "2022-11-15", "2022-11-18", "passageiro", "https://images.unsplash.com/photo-1580996378027-23040f16f157?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80", "https://images.unsplash.com/photo-1542343633-ce3256f2183e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip4 = new Trip("Ric", "Nuno", "Copenhagen", "Denmark", "2022-10-25", "2023-12-31", "viajante", "https://images.unsplash.com/photo-1552560880-2482cef14240?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=443&q=80", "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")
  const trip5 = new Trip("Dan", "Ellon", "Porto", "Portugal", "2022-05-20", "2022-12-31", "passageiro", "https://images.unsplash.com/photo-1569959220744-ff553533f492?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1164&q=80", "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1176&q=80")
  const trip6 = new Trip("Caroline", "Beatrice", "Seoul", "South Korea", "2022-02-23", "2022-03-10", "passageiro", "https://images.unsplash.com/photo-1538485399081-7191377e8241?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=374&q=80", "https://images.unsplash.com/photo-1531123414780-f74242c2b052?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip7 = new Trip("Ailynn", "Nuno", "Havana", "Cuba", "2022-10-03", "2022-10-07", "viajante", "https://images.unsplash.com/photo-1588614380453-69f03be5e097?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", "https://images.unsplash.com/photo-1488161628813-04466f872be2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80")
      ...
      <ScrollView>
        ...
        <View>
          <Text style={styles.title}>Ongoing trips</Text>
            {ongoingTripsCards.map((item, index) => (
            <View key={index.toString()}>
            <Pressable onPress={() => DetailsPage(ongoing[index])}>
              {item}
            </Pressable>
            </View>))}
        </View>
        ...
        <View>
          <Text style={styles.title}>Past trips</Text>
            {pastTripsCards.map((item, index) => (
            <View key={index.toString()}>
            <Pressable onPress={() => DetailsPage(past[index])}>
              {item}
            </Pressable>
            </View>))}
        </View>
