...
export function FoundTrips({ route, navigation }){    
  ...
  const trip1 = new Trip("", "Joana", "Cairo", "Egypt", "2023-05-03", "2023-05-10", "passageiro", "https://images.unsplash.com/photo-1562842523-6d492ddc3e25?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80", "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip2 = new Trip("", "Robert", "Cairo","Egypt", "2023-01-23", "2023-01-31", "passageiro", "https://images.unsplash.com/photo-1561778498-2d8ef2ade19e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=973&q=80", "https://images.unsplash.com/photo-1521119989659-a83eee488004?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=423&q=80")
  const trip3 = new Trip("", "Carlo", "Cairo","Egypt", "2023-01-27", "2023-02-04", "passageiro", "https://images.unsplash.com/photo-1569531955317-390fbbc73f17?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", "https://images.unsplash.com/photo-1599566150163-29194dcaad36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip4 = new Trip("", "Isa", "Berlin", "Germany", "2023-03-26", "2023-03-30", "passageiro", "https://images.unsplash.com/photo-1552553302-9211bf7f7053?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80", "https://images.unsplash.com/photo-1563620915-8478239e9aab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80")
  const trip5 = new Trip("", "Anne Marie", "Paris", "France","2023-03-27", "2023-04-10", "passageiro", "https://images.unsplash.com/photo-1551634979-2b11f8c946fe?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")
  const trip6 = new Trip("", "Fred", "Madrid", "Spain", "2023-05-03", "2023-5-10", "passageiro", "https://images.unsplash.com/photo-1570698473651-b2de99bae12f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=436&q=80", "https://images.unsplash.com/photo-1615813967515-e1838c1c5116?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
  const trip7 = new Trip("", "Polly", "Monte Carlo", "Monaco", "2023-05-03", "2023-05-10", "passageiro", "https://images.unsplash.com/photo-1570003550321-14dd053a5956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=465&q=80", "https://images.unsplash.com/photo-1542596768-5d1d21f1cf98?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80")
    ...
    if (counter === 0){
      if (counterDate === 0){
        for(let i = 0; i < futureTrips.length; i++){
          if (futureTrips[i].place.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase()){
        ...
        for(let i = 0; i < futureTrips.length; i++){
          if ((futureTrips[i].place.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase() ) && futureTrips[i].startDate.toDateString() === date.toDateString()){
            futureTripsCards.push(Card(futureTrips[i]))
            trips.push(futureTrips[i])
          }
        }
        if (futureTripsCards.length === 0){
          for(let i = 0; i < futureTrips.length; i++){
            ...
            if ((futureTrips[i].place.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === route.params.firstLoc.toLocaleLowerCase()) && (datediff < 5 && datediff > -5)){
              futureTripsCards.push(Card(futureTrips[i]))
              trips.push(futureTrips[i])
            }
          }
      ...
      if (counterDate === 0 ){
        for(let i = 0; i < futureTrips.length; i++){
          if (futureTrips[i].place.toLocaleLowerCase() === location.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === location.toLocaleLowerCase()){
            futureTripsCards.push(Card(futureTrips[i]))
            trips.push(futureTrips[i])
          }
        }
        ...
        for(let i = 0; i < futureTrips.length; i++){
          if ((futureTrips[i].place.toLocaleLowerCase() === location.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === location.toLocaleLowerCase()) && futureTrips[i].startDate.toDateString() === date.toDateString()){
            futureTripsCards.push(Card(futureTrips[i]))
            trips.push(futureTrips[i])
          }
        }
        if (futureTripsCards.length === 0){
          for(let i = 0; i < futureTrips.length; i++){
            const datediff = daysBetweenDates(date, futureTrips[i].startDate);
            if ((futureTrips[i].place.toLocaleLowerCase() === location.toLocaleLowerCase() || futureTrips[i].country.toLocaleLowerCase() === location.toLocaleLowerCase()) && (datediff < 5 && datediff > -5)){
              futureTripsCards.push(Card(futureTrips[i]))
              trips.push(futureTrips[i])
            }
          }
